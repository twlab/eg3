...
export const { setCustomGenomes, setCustomGenomesLoadStatus } = genomeHubSlice.actions;

const genomeHubSelectors = genomeHubAdapter.getSelectors((state: RootState) => state.genomeHub.customGenomes);

export const selectCustomGenomes = (state: RootState) => genomeHubSelectors.selectAll(state);
export const selectCustomGenomeById = (state: RootState, id: string) => genomeHubSelectors.selectById(state, id);

export const selectCustomGenomesLoadStatus = (state: RootState) => state.genomeHub.customGenomeLoadStatus;
