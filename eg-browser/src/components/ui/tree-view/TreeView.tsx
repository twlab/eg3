...
import { ITrackModel } from "@eg/tracks/src/types/track-container";
import { variableIsObject } from "@eg/core/src/eg-lib/util";
                                        ...
                                        {groupTracks.map((track) => (
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className={`px-3 py-1 rounded-md ${addedTrackSets?.has(track.url) || addedTrackSets?.has(track.name)
