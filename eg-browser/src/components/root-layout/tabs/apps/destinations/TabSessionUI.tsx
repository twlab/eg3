...
const SessionUI: React.FC<SessionUIProps> = ({
    ...
    const [newSessionLabel, setNewSessionLabel] = useState<string>(
        state?.title && !bundleId && state.title !== "Untitled Session" ? state.title : ""
    );
    console.log(state)
                    ...
                    <>
                        {showFullUI ? (
                            <>
                                ...
                                <div style={styles.inputContainer}>
                                    <div style={styles.label}>
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '12px', width: '100%' }}>
                                            <span style={{ fontWeight: 600, whiteSpace: 'nowrap' }}>Add New Session To Bundle</span>
                                            <div
                                                style={{
                                                    display: "flex",
                                                    alignItems: "center",
                                            ...
                                            >
                                                <code
                                                    ...
                                                    title={bundle && bundle.bundleId ? "Click to copy bundle ID" : "Save a session to generate ID"}
                                                    style={{
                                                        flex: "1",
                                                        fontSize: "14px",
                                                        color: "blue",
                                                        ...
                                                        whiteSpace: 'nowrap',
                                                        cursor: bundle && bundle.bundleId ? 'pointer' : 'default',
                                                ...
                                                {copiedId && (
                                                    <span style={{ fontSize: 12, color: '#2b8a3e' }}>Copied</span>
                                                )}
                                            </div>
                                        </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center', marginTop: '16px' }}>
                                {!showCreateInput ? (
                                    <button
                                        style={{ ...styles.button, padding: '12px 16px' }}
                                        onClick={() => {
                                            setShowCreateInput(true);

                                            setNewSessionLabel(state?.title && !bundleId && state.title !== "Untitled Session" ? state.title : "")
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', width: '100%', alignItems: 'center' }}>
                                        <input
                                            ...
                                            placeholder="Enter new session name (optional)"
                                            className="SessionUI-create-input"
                                            style={{ ...styles.input, flex: 1 }}
                                        />
                                        <button onClick={handleAttemptSave} style={{ ...styles.button, marginLeft: '8px' }}>
                                            Save
                                        </button>
                                        <button onClick={() => {
                                            setShowCreateInput(false);
