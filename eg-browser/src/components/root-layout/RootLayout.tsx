...
import { selectNavigationTab, setNavigationTab, selectSessionPanelOpen } from "../../lib/redux/slices/navigationSlice";
...
export default function RootLayout() {
    ...
    const { ref: contentRef, width: contentWidth, height: contentHeight } = useElementGeometry();
                ...
                <div className="flex flex-row flex-1 relative" ref={contentRef}>
                    ...
                    <motion.div
                        ...
                        animate={{
                            ...
                            filter: sessionPanelOpen ? 'blur(5px) brightness(0.7)' : 'blur(0px) brightness(1)',
                        }}
                        style={{
                    ...
                    >
                        ...
                        >
                            <AnimatePresence mode="wait">
                                {sessionId !== null ? (
                                    <motion.div
                                        className="flex flex-col items-center justify-between h-full w-screen overflow-auto"
                                        key="genome-view"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        exit={{ opacity: 0 }}
