...
class BigSourceWorker {
    ...
    async getData(loci: any, basesPerPixel: any, options: any): Promise<any[]> {
        ...
        let promises = loci.map((locus: any) => this._getDataForChromosome(locus, bigWigObj, zoomLevel));
    ...
    _getMatchingZoomLevel(bigWigObj: any, basesPerPixel: number): number {
        ...
        let desiredZoom = sortedZoomLevels.find((zoomLevel: any) => zoomLevel.reduction < basesPerPixel);
        return bigWigObj.zoomLevels.findIndex((zoomLevel: any) => zoomLevel === desiredZoom);
    }
