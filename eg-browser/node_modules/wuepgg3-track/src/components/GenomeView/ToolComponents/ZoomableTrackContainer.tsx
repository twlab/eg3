 ...
 * @author Silas Hsu
 */
function UnconnectedZoomableTrackContainer(
  props: ZoomableTrackContainerProps
): JSX.Element {
  ...
  return (
    <SelectableGenomeArea
      ...
      dragLimits={
        new OpenInterval(legendWidth, legendWidth + viewWindow.getLength())
      }
...
export const ZoomableTrackContainer = withTrackLegendWidth(
  UnconnectedZoomableTrackContainer
);
