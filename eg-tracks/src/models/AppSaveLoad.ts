...
const DEFAULT_TRACK_LEGEND_WIDTH = 120;
...
export class AppStateSaver {
  ...
  toObject(appState: any): object {
    ...
    const object = {
      ...
      viewInterval: appState.viewInterval ? appState.viewInterval : null,
      viewRegion: appState.viewRegion ? appState.viewRegion : null,
