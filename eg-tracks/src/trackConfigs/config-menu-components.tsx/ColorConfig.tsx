...
export function LegendFontColorConfig(props) {
  return <ColorConfig {...props} optionName="color" label="Legend font color" />;
}
/**
...
export function PrimaryAboveColorConfig(props) {
  return (
    <ColorConfig
      {...props}
      optionName="colorAboveMax"
      label="Primary color above max"
    />
  );
}
...
export function SecondaryBelowColorConfig(props) {
  return (
    <ColorConfig
      {...props}
      optionName="color2BelowMin"
      label="Secondary color below min"
    />
  );
}
...
export function queryGenomeColorConfig(props) {
  return (
    <ColorConfig
      {...props}
      optionName="queryColor"
      label="Query genome color"
    />
  );
}
