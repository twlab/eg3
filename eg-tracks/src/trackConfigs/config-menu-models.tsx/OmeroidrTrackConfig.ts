...
const THUMBNAIL_URL =
  "https://idr.openmicroscopy.org/webclient/render_thumbnail";
const THUMBNAIL_URL_SUFFIX = "";
const THUMBNAIL_DATA =
  "https://idr.openmicroscopy.org/webclient/get_thumbnails";

const IMAGE_URL_REGION =
  "https://idr.openmicroscopy.org/webclient/render_image_region";
...
export class OmeroidrTrackConfig extends OmeroTrackConfig {
  constructor(trackModel: TrackModel) {
    super(trackModel);
    const apiConfig = {
      imageUrl: trackModel.options.renderImageRegion
        ? IMAGE_URL_REGION
        : IMAGE_URL,
      imageUrlSuffix: trackModel.options.renderImageRegion
        ? IMAGE_URL_SUFFIX_REGION
        : IMAGE_URL_SUFFIX,
