...
const ShapeMenu = (props) => {
  const { id, shape, onUpdateMyShapes, onDeleteShapeByKey, onSetMessage } =
    props;
  ...
  return (
    ...
    >
      ...
      <button
        title="Update"
        className="btn btn-primary btn-sm btn-dense"
        onClick={updateShape}
      >
