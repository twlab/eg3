...
const HoverTooltip: React.FC<HoverToolTipProps> = memo(function tooltip({
  ...
  const handleMouseEnter = (e) => {
    if (
      ...
      let dataIdxX = Math.round(e.clientX - rect.left);
      let dataIdxY = Math.round(e.clientY - rect.top);
          ...
          {ReactDOM.createPortal(
            <div
              style={{
                ...
                transform: `translate(${
                  rectPosition.left + 150 > window.innerWidth ? -150 : 0
                }px, ${
                  rectPosition.top + 150 > window.innerHeight ? -150 : 0
                }px)`,
              }}
            >
