  ...
  const createInfiniteOnMessage = (
    ...
    event.data.forEach((dataItem: any) => {
      ...
      if (curDrawData) {
        ...
        if (curDrawData["trackToDrawId"] && Object.keys(curDrawData["trackToDrawId"]).length > 0) { checkDrawData(curDrawData); }
      }
    });
  };
  ...
  function getWindowViewConfig(viewWindow, dataIdx) {
    if (viewWindow && dataIdx !== undefined && dataIdx !== null) {
      ...
      for (let key in trackFetchedDataCache.current) {
        ...
        if (
          !configOptions || (!(cacheTrackData.trackType in numericalTracks) &&
            ...
            >
              ...
              >
                ...
                >
                  ...
                  region in {Math.round(windowWidth)}px, 1px spans equals{" "}
