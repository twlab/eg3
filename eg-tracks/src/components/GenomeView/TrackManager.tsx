...
import ReorderMany from "./ToolComponents/ReorderMany";
...
const TrackManager: React.FC<TrackManagerProps> = memo(function TrackManager({
  ...
  const createGenomeAlignOnMessage = (event: MessageEvent) => {
    ...
    // Process all fetch results synchronously
    Object.values(event.data.fetchResults).forEach((item: any) => {
      createCache({
        trackState: curTrackState,
        result: item.records,
        id: item.id,
  ...
  function toolSelect(toolTitle: string | number) {
    ...
    else { newSelectedTool["title"] = toolTitle };
      ...
      <OutsideClickDetector onOutsideClick={onTrackUnSelect}>
        {showToolBar ? (
          ...
          >
            ...
            /> */}
            <ReorderMany tracks={tracks} selectedTool={selectedTool} onOpenReorderManyModal={function (): void {
              throw new Error("Function not implemented.");
            }} onCloseReorderManyModal={function (): void {
              throw new Error("Function not implemented.");
