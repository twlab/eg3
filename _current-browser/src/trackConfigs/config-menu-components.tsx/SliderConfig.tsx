...
// Define interface for Track component props
...
// Define interface for SliderConfig component props
...
// Define interface for SliderConfig component state
...
> {
  ...
  constructor(props) {
    ...
    this.onUpdate =
      props.onUpdate === undefined ? this.onUpdate.bind(this) : props.onUpdate;
    this.onChange =
      props.onChange === undefined ? this.onChange.bind(this) : props.onChange;
  }
