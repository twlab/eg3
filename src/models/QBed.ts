...
class QBed extends Feature {
  ...
  annotation: any;
  value: number;
  relativeX: number | undefined; // Store relative position of QBed in visualizer
  relativeY: number | undefined; // Used to find nearest QBed to cursor for tooltip; also for downsampling
