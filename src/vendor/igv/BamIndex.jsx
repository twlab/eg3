 ...
 * @param tabix
 *
 * @returns a bam or tabix index.  The fulfill function takes the index as an argument.
 */
const makeBamIndex = function (arrayBuffer, tabix) {
  var indices = [],
    magic,
    nbin,
    nintv,
  ...
  magic = parser.getInt();
  if (tabix && magic !== TABIX_MAGIC) {
    throw new Error("Not a tabix file.");
  } else if (!tabix && magic !== BAI_MAGIC) {
