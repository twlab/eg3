        ...
        <NavigationStack destinations={destinations} rootOptions={{ title: 'Tracks' }}>
            <div className="flex flex-col gap-4">
                ...
                <div className="text-sm text-gray-500">
                    {viewRegion && (
                        <div>
                            Current region: {viewRegion.getGenomeIntervals()[0].chr}:{viewRegion.getGenomeIntervals()[0].start + 1}-{viewRegion.getGenomeIntervals()[0].end}
                        </div>
                    )}
                </div>
                <DescriptiveNavigationLink
