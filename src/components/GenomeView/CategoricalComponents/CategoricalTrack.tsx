...
interface CategoricalTrackProps
...
class CategoricalTrackNoTooltip extends React.Component<CategoricalTrackProps> {
  ...
  renderAnnotation(
    ...
    return placedGroup.placedFeatures.map((placement, i) => {
      ...
      const color =
        category && category[featureName]
          ? category[featureName].color
          : "blue";
      return (
...
export const CategoricalTrack = withDefaultOptions(
  withTooltip(CategoricalTrackNoTooltip as any)
);
